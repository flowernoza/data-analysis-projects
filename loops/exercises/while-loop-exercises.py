...
while num_of_astronauts < 1 or num_of_astronauts > 7:
   num_of_astronauts = int(input("Enter the number of astronauts aboard: "))  

# c. Use a final loop to monitor the fuel status and the altitude of the shuttle. Each iteration, decrease the fuel level by 100 units for each astronaut aboard. Also, increase the altitude by 50 kilometers.
while starting_fuel_level-100 * num_of_astronauts >= 0:
   altitude += 50
   starting_fuel_level -= 100 * num_of_astronauts
